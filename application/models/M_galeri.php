...
class M_galeri extends CI_Model
{
	...
	function simpan_galeri($album, $user_id, $user_nama, $gambar)
	{
		$this->db->trans_start();
		$this->db->query("insert into tbl_galeri(galeri_album_id,galeri_pengguna_id,galeri_author,galeri_gambar) values ('$album','$user_id','$user_nama','$gambar')");
	...
	function update_galeri($galeri_id, $album, $user_id, $user_nama, $gambar)
	{
		$hsl = $this->db->query("update tbl_galeri set galeri_album_id='$album',galeri_pengguna_id='$user_id',galeri_author='$user_nama',galeri_gambar='$gambar' where galeri_id='$galeri_id'");
		return $hsl;
	}
	function update_galeri_tanpa_img($galeri_id, $album, $user_id, $user_nama)
	{
		$hsl = $this->db->query("update tbl_galeri set galeri_album_id='$album',galeri_pengguna_id='$user_id',galeri_author='$user_nama' where galeri_id='$galeri_id'");
		return $hsl;
	}
