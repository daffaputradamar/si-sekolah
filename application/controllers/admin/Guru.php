...
class Guru extends CI_Controller
{
	...
	function index()
	{
		...
		$this->data['breadcrumb']  = 'Data Guru dan Staf';
	...
	function simpan_guru()
	{
		...
		if (!empty($_FILES['filefoto']['name'])) {
			if ($this->upload->do_upload('filefoto')) {
				...
				$this->m_guru->simpan_guru($nip, $nama, $photo, $jabatan);
			...
			$this->m_guru->simpan_guru_tanpa_img($nip, $nama, $jabatan);
			echo $this->session->set_flashdata('msg', 'success');
			redirect('admin/guru');
		}
	}
	...
	function update_guru()
	{
		...
		if (!empty($_FILES['filefoto']['name'])) {
			if ($this->upload->do_upload('filefoto')) {
				...
				$this->m_guru->update_guru($kode, $nip, $nama, $photo, $jabatan);
			...
			$nama = strip_tags($this->input->post('xnama'));
			$jabatan = strip_tags($this->input->post('xjabatan'));
			$this->m_guru->update_guru_tanpa_img($kode, $nip, $nama, $jabatan);
			echo $this->session->set_flashdata('msg', 'info');
			redirect('admin/guru');
		}
	}
